# ----------------------------------------------------------------------------------------
#   pyi.mac.onefile.spec - WRW 26-Mar-2025  - finally trying to package birdland-qt

#   Called by build.mac.onefile.sh
# ----------------------------------------------------------------------------------------
...
exe = EXE(
  ...
  # exclude_binaries=True,                  # Smoking gun! exclude_binaries=False caused a big, big headache.
    ...
    icon='src/Icons/Saxophone_64.icns',      # WRW 4-May-2025 - must be .icns on mac
)

#   Omit Collect() for onefile
