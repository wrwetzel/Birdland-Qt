...
#     ( 'lib/libvlc.so.5',     '/usr/lib/libvlc.so.5',     'BINARY' ),
#     ( 'lib/libvlccore.so.9', '/usr/lib/libvlccore.so.9', 'BINARY' ),
]
...
exe = EXE(
    ...
    exclude_binaries=False,               # Testing True for onefile. Appears to be fine.
#   exclude_binaries=True,                # Smoking gun on onedir! exclude_binaries=False caused a big, big headache.
    name='birdland_qt',
    debug=False,
