...
#   WRW 22 Dec 2021 -                                                
#   WRW 17-Mar-2025 - Update to latest architecture for Birdland-Qt Lite
...
def do_main( verbose, all, canon, list, database, confdir, summary, page_summary ):
    ...
    s.conf = Config()     # /// RESUME - add confdir arg to this when include cmd-line options.
    s.fb = FB()
    ...
    if MYSQL:
        ...
        # conn = sqlite3.connect( Path( s.conf.home_confdir, s.conf.sqlite_database ))     # Note: always in home_confdir
